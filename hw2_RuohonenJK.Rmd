...
dl<-t(X)%*%(y-p0) #Transpositions and matrix multiplications. This is where I fall off the wagon. "DERIVATIVES OF LOG-LIKELIHOOD""    p(x,g)  ovat se tuttu kaava. kunkin havaintoyksikön todennäköisyys on e potenssiin xi + gi.  Likelihood equation: se iso pylvässymboli on TULO. derivoidaan se niiden 3 argumentin suhteen.  transpoosia niin kolonnat muuttuvat riveiksi. NEwtonissa sitten otetaan derivaattojen derivaattoja jotta päästään sinne missä kulmakerroin 0 eli asiat ei enää muutu.
